                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-head-row card-tools-still-right">
                                    <h4 class="card-title">Consultar Atendimentos</h4>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header border-0">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Dados do Atendimento</span>
                                                </h5>
                                                <button
                                                    type="button"
                                                    class="close"
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <div class="form-button-action">
                            <button type="button" data-bs-toggle="tooltip" title="Visualizar" class="btn btn-link btn-primary btn-lg btn-visualizar" data-protocolo="${row.protocolo}">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.error) {
                        ...
                        var url = 'gerar_pdf.php?protocolo=' + encodeURIComponent(data.protocolo) +
                            '&assunto=' + encodeURIComponent(data.assunto) +
                            '&data=' + encodeURIComponent(data.data) +
                            '&id_assistente=' + encodeURIComponent(data.id_assistente) +
                            '&id_usuario=' + encodeURIComponent(data.id_usuario) +
                            '&descricao=' + encodeURIComponent(data.descricao);
                        window.open(url, '_blank');
                    }
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                    alert('Erro ao buscar os dados do atendimento.');
                }
            });
        });
    </script>
